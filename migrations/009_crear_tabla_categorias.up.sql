CREATE TABLE categorias (
  ...
  creado_por       BIGINT UNSIGNED NOT NULL COMMENT 'FK a empleados.id — quién creó el registro',
  creado_en        DATETIME        NOT NULL,
  actualizado_por  BIGINT UNSIGNED NOT NULL COMMENT 'FK a empleados.id — último que modificó',
